...
Drafter uses integrant for its configuration.  To launch drafter you
must now supply as a command line a file specifying the configuration
of your authentication mode (and/or) overrides for any other aspects
of the integrant system.
...
Some working example files to run drafter can be found in the omni
package at [[../package/install/][../package/install]]
