...
- [[../../package/install/drafter-dev-auth0.edn][drafter-dev-auth0.edn]] dev mode auth0 config
- [[../../package/install/drafter-dev-basic-auth-memory-db.edn][drafter-dev-basic-auth-memory-db.edn]] dev mode users database, where the users are configured in the config file.
