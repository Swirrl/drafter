...
(t/deftest format-body-test
  (t/testing "File"
    (let [file (io/file "test/resources/rdf-syntax-ns.ttl")
          {:keys [input worker]} (sut/format-body file :ttl nil)]
  ...
  (t/testing "File with gzip"
    (let [file (io/file "test/resources/rdf-syntax-ns.ttl")
          ...
          {:keys [input worker]} (sut/format-body file :ttl true)]
  ...
  (t/testing "InputStream"
    (let [file (io/file "test/resources/rdf-syntax-ns.ttl")
      ...
      (with-open [is (io/input-stream file)]
        (let [{:keys [input worker]} (sut/format-body is :ttl nil)]
          (t/is (= is input))
          (t/is (nil? worker))
  ...
  (t/testing "InputStream to gzip"
    (let [file (io/file "test/resources/rdf-syntax-ns.ttl")
          input-statements (set (gio/statements file))]
      (with-open [is (io/input-stream file)]
        (let [{:keys [input worker]} (sut/format-body is :ttl true)]
          (t/is (instance? InputStream input))
          (t/is (some? worker))
  ...
  (t/testing "Statements"
    (let [g1 (URI. "http://g1")
      ...
      (t/testing "uncompressed"
        (let [{:keys [input worker]} (sut/format-body quads "application/n-quads" nil)]
          (t/is (instance? InputStream input))
          (t/is (some? worker))
      ...
      (t/testing "gzipped"
        (let [{:keys [input worker]} (sut/format-body quads "application/n-quads" true)]
          (t/is (instance? InputStream input))
          (t/is (some? worker))
