(ns drafter-swagger-client.core
...
(def auth-definitions
  {"basic-auth" {:type :basic}
   "jws-auth" {:type :api-key :in :header :param-name "Authorization"}})
...
(defn call-api
  ...
  [path method {:keys [path-params body-param content-types accepts auth-names
                       as] :as opts}]
