...
Two middleware functions are provided by default in the `drafter.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `drafter.handler` namespace to manage the enabled middleware.
